...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-vg_fixedsplit_linears_boxfix_clean_20260610}"
TOTAL_ITERS="${TOTAL_ITERS:-1000}"
SAVE_EVERY_ITERS="${SAVE_EVERY_ITERS:-250}"
ALLOW_RESUME="${ALLOW_RESUME:-0}"
OUTPUT_ROOT="${OUTPUT_ROOT:-/root/autodl-tmp/GLIGEN/OUTPUT_FIXED_CLEAN_GEOPRED_REPAIRED}"
