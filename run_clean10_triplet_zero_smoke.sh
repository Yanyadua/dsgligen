...
# Training-free wiring check. The triplet fuser's final projection is zero at
# initialization, so this must match the fixed clean-box baseline exactly.
...
export OUT_DIR="${OUT_DIR:-/root/autodl-tmp/GLIGEN/eval_outputs/clean10_triplet_zero_c_no_token_20260713}"
