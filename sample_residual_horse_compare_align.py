...
sys.path.insert(0, "/root/autodl-tmp/GLIGEN")
...
EXPS = [
    ...
    ("gat_residual_align", "configs/vg_scene_graph_gat_residual.yaml", "OUTPUT_ALIGN/vg_scene_graph_gat_residual_align_mlpinit_2k/tag00/checkpoint_00002000.pth"),
]
