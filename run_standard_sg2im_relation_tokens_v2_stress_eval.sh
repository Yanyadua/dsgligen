...
OUT_DIR="${OUT_DIR:-/root/autodl-tmp/GLIGEN/eval_outputs/stress_relation_tokens_v2_ddim50}"
...
export MODEL_YAML="${MODEL_YAML:-configs/vg_standard_sg2im_scene_graph_relation_tokens_v2.yaml}"
export DATA_YAML="${DATA_YAML:-configs/vg_standard_sg2im_scene_graph_relation_tokens_v2.yaml}"
...
export MAX_RELATION_GROUNDING_TOKENS="${MAX_RELATION_GROUNDING_TOKENS:-3}"
export RELATION_GROUNDING_ALLOWED_PREDICATES="${RELATION_GROUNDING_ALLOWED_PREDICATES:-on,on top of,under,below,above,inside,in front of,behind,holding,riding,wearing,sitting on,standing on,walking on,carrying}"
export DEDUP_RELATION_GROUNDING_TOKENS="${DEDUP_RELATION_GROUNDING_TOKENS:-1}"
