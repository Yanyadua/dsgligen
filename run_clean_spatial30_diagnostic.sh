...
# Exploratory diagnostic only: 30 fixed VG test examples, no FID/IS/OOR.
# The four arms isolate caption, object-cleaning, and relation-token effects.
...
# A: existing diagnostic condition, including its weak graph-style caption.
...
run_one clean30_a_legacy_graph_caption_20260712

# B: caption-only intervention.
export CONDITIONING_POLICY=legacy
export CAPTION_POLICY=clean
export ENABLE_RELATION_GROUNDING_TOKENS=0
export MAX_RELATION_GROUNDING_TOKENS=0
run_one clean30_b_legacy_color_caption_20260712

# C: caption plus clean object selection, but no relation token.
...
export ENABLE_RELATION_GROUNDING_TOKENS=0
export MAX_RELATION_GROUNDING_TOKENS=0
run_one clean30_c_clean_objects_color_caption_20260712

# D: clean condition plus the single, conservative spatial relation token.
...
run_one clean30_d_clean_top1_relation_s050_20260712
