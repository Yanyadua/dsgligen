...
TRAIN_ROOT="${TRAIN_ROOT:-/root/autodl-tmp/GLIGEN/OUTPUT_FIXED_NORMMATCH/vg_fixedsplit_normmatch_300_20260620/tag00}"
OUT_ROOT="${OUT_ROOT:-/root/autodl-tmp/GLIGEN/eval_outputs/normmatch_300_checkpoints_20260620}"
